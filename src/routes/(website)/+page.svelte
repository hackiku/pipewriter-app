  ...
  <main class="container flex-grow px-4 sm:px-6 md:px-16 lg:px-24 xl:px-44">
    ...
    <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 pt-20 lg:pt-40">
      ...
      <div class="flex flex-col items-start space-y-8 lg:w-[45%]">
        ...
        <div class="inline-flex items-center gap-1.5 px-3 py-1 mb-2 rounded-full bg-primary/10 text-primary border border-primary/20">
          <Sparkles class="w-4 h-4" />
          <span class="text-sm font-medium">Type + Prototype</span>
        </div>
...
<section class="py-16">
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div class="flex flex-col items-center text-center group">
      <div class="mb-4">
        <FileText class="w-12 h-12 opacity-40 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
    ...
    <div class="flex flex-col items-center text-center group">
      <div class="mb-4">
        <Layout class="w-12 h-12 opacity-40 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
