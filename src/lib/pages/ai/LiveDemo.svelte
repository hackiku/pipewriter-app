...
<section class="container py-12 border-t">
  <div class="max-w-4xl mx-auto">
    <div class="relative rounded-lg border overflow-hidden">
      ...
      <!-- Gradient Overlay -->
      <div class="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-background to-transparent">
        <div class="absolute bottom-0 left-0 right-0 p-6 text-center">
          <h3 class="text-xl font-semibold mb-4">See what you can build with Pipewriter</h3>
