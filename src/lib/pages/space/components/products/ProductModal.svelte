...
>
  ...
  <button
    on:click={onClose}
    class="fixed top-8 right-8 flex items-center gap-2 px-4 py-2 rounded-lg
  ...
  <!-- Modal -->
  <div 
    class="relative w-full max-w-4xl bg-card rounded-xl shadow-xl
           overflow-hidden"
    transition:scale={{ duration: 300, easing: quintOut }}
  >    
    <!-- Content -->
    <div class="grid grid-cols-2 min-h-[80vh]">
      <!-- Left: Image -->
