...
<div class="space-y-16">
  ...
  <div class="relative">
    ...
    <div class="text-center mb-12">
      <h2 class="text-[4vh] sm:text-[5vh] font-medium leading-[1.1] tracking-tight
                 max-w-[16ch] mx-auto">
    ...
    <div class="relative">
      ...
      {#if !showComparison}
        <div class="relative pt-16">
          <div class="absolute inset-x-0 top-0 h-24 bg-gradient-to-t from-transparent to-background" />
