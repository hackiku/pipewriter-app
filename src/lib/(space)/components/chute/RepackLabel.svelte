...
>
  ...
  <svg
    ...
    height="24"
    viewBox="0 0 24 24"
    class="absolute {type === 'before' ? '-bottom-6 left-8' : '-bottom-6 right-8'} 
           {type === 'before' ? 'rotate-[-30deg]' : 'rotate-[30deg]'}"
  >
    <path
      d={arrowPath}
      stroke="currentColor"
